...
// `admin/reportes/donaciones` (the review/cancel module these labels
// originally came from) hasn't been ported yet — defined locally to avoid a
// dependency on an unported module.
              ...
              <div className="flex-1">
                ...
                <details className="mt-3">
                  ...
                  <div className="mt-2 p-3 bg-white border border-blue-200 rounded text-xs space-y-2">
                    <p className="font-medium">1. Conecta a la base de datos con psql o tu cliente Postgres</p>
                    ...
                    <code className="block bg-gray-900 text-green-400 p-2 rounded font-mono">
                      src/db/migrations/*.sql (en orden ascendente)
                    </code>
                ...
                {error.includes('migraciones') && (
                  <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded">
                    ...
                    <p className="text-xs text-yellow-700 mt-2">
                      Ejecuta los archivos en orden ascendente.
                    </p>
                  </div>
                )}
              </div>
