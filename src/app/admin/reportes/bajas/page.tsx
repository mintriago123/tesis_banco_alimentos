/**
 * @fileoverview Página de historial de bajas para administrador
 * Incluye todas las funcionalidades de operador más opciones administrativas
 */
...
export default function AdminHistorialBajasPage() {
  ...
  const cargarEstadisticas = useCallback(async () => {
    try {
      ...
      const response = await fetch(`/api/operador/bajas/estadisticas?periodo=${periodo}`);
  ...
  useEffect(() => {
    cargarBajas();
    cargarEstadisticas();
  }, [cargarBajas, cargarEstadisticas]);
  ...
  return (
    <DashboardLayout
      ...
      description="Gestión completa de bajas de productos"
    >
          ...
          {showStats && estadisticas && (
            <div className="mb-6 grid grid-cols-1 md:grid-cols-5 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
                <div className="text-sm font-medium text-blue-700">Total de Bajas</div>
                <div className="text-2xl font-bold text-blue-900 mt-1">
                  {estadisticas.total.bajas}
                </div>
                <div className="text-xs text-blue-600 mt-1">
                  {estadisticas.total.cantidad.toFixed(0)} unidades
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-4 border border-red-200">
                ...
                <div className="text-2xl font-bold text-red-900 mt-1">
                  {estadisticas.por_motivo.vencido.bajas}
                </div>
                <div className="text-xs text-red-600 mt-1">
                  {estadisticas.por_motivo.vencido.cantidad.toFixed(0)} unidades
                </div>
              </div>
              
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 border border-orange-200">
                <div className="text-sm font-medium text-orange-700">Dañados</div>
                <div className="text-2xl font-bold text-orange-900 mt-1">
                  {estadisticas.por_motivo.dañado.bajas}
                </div>
                <div className="text-xs text-orange-600 mt-1">
                  {estadisticas.por_motivo.dañado.cantidad.toFixed(0)} unidades
                </div>
              </div>
              
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
                <div className="text-sm font-medium text-purple-700">Contaminados</div>
                <div className="text-2xl font-bold text-purple-900 mt-1">
                  {estadisticas.por_motivo.contaminado.bajas}
                </div>
                <div className="text-xs text-purple-600 mt-1">
                  {estadisticas.por_motivo.contaminado.cantidad.toFixed(0)} unidades
                </div>
              </div>
              
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg p-4 border border-yellow-200">
                <div className="text-sm font-medium text-yellow-700">Otros</div>
                <div className="text-2xl font-bold text-yellow-900 mt-1">
                  {estadisticas.por_motivo.otro.bajas + estadisticas.por_motivo.rechazado.bajas}
                </div>
                <div className="text-xs text-yellow-600 mt-1">
                  {(estadisticas.por_motivo.otro.cantidad + estadisticas.por_motivo.rechazado.cantidad).toFixed(0)} unidades
                </div>
              </div>
            </div>
          )}
