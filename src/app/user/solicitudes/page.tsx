...
import { useSolicitudes, SolicitudesList, FiltroEstadoSolicitud, Solicitud, SolicitudEditData, MESSAGES } from '@/modules/user';
...
export default function MisSolicitudesPage() {
  ...
  const { solicitudes, updateSolicitud, deleteSolicitud } = useSolicitudes(filtroEstado);
  ...
  return (
    <DashboardLayout requiredRole="SOLICITANTE" title="Mis Solicitudes" description="Revisa el historial de tus solicitudes de alimentos.">
      <SolicitudesList solicitudes={solicitudes} filtroEstado={filtroEstado} onFiltroChange={setFiltroEstado} onDelete={handleEliminar} onEdit={handleEditar} mensaje={mensaje} />
    </DashboardLayout>
  );
}
