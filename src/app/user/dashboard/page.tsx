...
import { DashboardUserCards, useSolicitudes } from '@/modules/user';
import { useDatosBasicosUsuario } from '@/modules/shared/hooks/useProfileUpdate';

export default function UsuarioDashboardPage() {
  const { userData, loading: loadingUser, error: userError } = useDatosBasicosUsuario();
  ...
  return (
    <DashboardLayout requiredRole="SOLICITANTE" title="Panel de Solicitante" description="Solicita alimentos y sigue el avance de tus pedidos.">
        ...
        {isLoading ? (
          ...
          <>
            <div className="flex justify-end">
              <Button type="button" onClick={() => void handleRefresh()} disabled={isRefreshing} loading={isRefreshing} accent="solicitante">
