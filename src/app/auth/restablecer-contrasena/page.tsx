...
import { useResetPassword, PasswordInput, AuthButton, AuthMessage, AUTH_CONSTANTS } from '@/modules/auth';

function FormularioRestablecerContrasena() {
  const { restablecerContrasena, estaCargando, mensaje, sesionValida, verificandoSesion, limpiarMensaje } = useResetPassword();
  ...
  return (
    <>
      <div className="mb-8 text-center">
        <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">Restablecer Contraseña</h2>
      ...
      <form className="space-y-6" onSubmit={manejarEnvio}>
        ...
        <AuthButton type="submit" disabled={estaCargando || !sesionValida} cargando={estaCargando} textoNormal="Actualizar Contraseña" textoCargando="Actualizando..." />
