      ...
      <div className="relative z-10 mx-auto w-full max-w-md">
        <div className="flex flex-col items-center mb-6 sm:mb-8">
          <div className="mb-2 rounded-full border border-blue-100 bg-white p-2 shadow-sm sm:mb-3 sm:p-3">
            <Image src="/favicon2.ico" alt="Logo del Banco de Alimentos" width={56} height={56} priority className="drop-shadow-xl sm:w-16 sm:h-16" />
          </div>
          <h1 className="px-4 text-center text-xl font-extrabold tracking-tight text-slate-950 sm:text-2xl md:text-3xl">Banco de Alimentos</h1>
          <p className="mt-1 px-4 text-center text-xs font-medium text-slate-600 sm:text-sm">Proyecto de Vinculación con la Sociedad &bull; ULEAM</p>
        </div>

        <div className="rounded-2xl border border-slate-200 bg-white px-6 py-8 shadow-xl shadow-slate-900/5 sm:px-8 sm:py-10 md:p-10">{children}</div>
      </div>
    </div>
  );
};
