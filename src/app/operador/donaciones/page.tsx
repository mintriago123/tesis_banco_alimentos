...
export default function OperadorDonationsPage() {
  ...
  return (
    <DashboardLayout requiredRole="OPERADOR" title="Gestión de Donaciones" description="Seguimiento y actualización de estados de donaciones">
      <div className="p-6 space-y-6">
        ...
        <div className="rounded-lg bg-blue-50 border border-blue-200 p-4">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Nota para Operadores</h3>
              <p className="mt-1 text-sm text-blue-700">Puedes actualizar el estado de las donaciones. La cancelación está reservada para donantes y administradores activos.</p>
            </div>
          </div>
        </div>
      </div>
