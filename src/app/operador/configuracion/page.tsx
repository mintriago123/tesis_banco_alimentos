...
import { changeOwnPasswordAction } from '@/modules/auth/actions/change-password';
...
export default function OperadorConfiguracionPage() {
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const text = error instanceof Error ? error.message : 'Error al cambiar la contraseña';
